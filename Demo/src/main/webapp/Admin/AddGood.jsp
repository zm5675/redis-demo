...
<body class="gray-bg">
    <div class="page-content-wrap">
        <form class="layui-form" action="${pageContext.request.contextPath}/AddGoodServlet" enctype="multipart/form-data" method="post">
            <div class="layui-tab" style="margin: 0;">
                <div class="layui-tab-content">
                    <div class="layui-tab-item">图书信息</div>
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="goodName"  id="goodName" placeholder="请输入图书名称" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">图书数量：</label>
                            <div class="layui-input-block">
                                <input type="text" name="goodCount"  id="goodCount" placeholder="请输入图书数量" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">图书单价：</label>
                            <div class="layui-input-block">
                                <input type="text" name="goodUnitPrice"  id="goodUnitPrice" placeholder="请输入图书单价" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">备注信息：</label>
                            <div class="layui-input-block">
                                <input type="text" name="content"  id="content" placeholder="请输入备注信息" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">图书图片：</label>
                            <div class="layui-input-block">
                                <input type="file" name="goodPicUrl"/>
                            </div>
                        </div>
                    </div>
                </div>
