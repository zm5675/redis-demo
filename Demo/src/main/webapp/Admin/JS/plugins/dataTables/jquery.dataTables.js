...
(/** @lends <global> */function( $ ) {
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		// If there is a width attr, we want to attach an event cn.itcast.mq.listener which
	...
	DataTable = function( options )
	{
		...
		/**
		 * Attach a sort cn.itcast.mq.listener to an element for a given column
		 *  @param {node} nNode the element to attach the sort cn.itcast.mq.listener to
	 ...
	 *   cn.itcast.mq.listener to. This can take the form of a single DOM node, a jQuery
	 *   collection of nodes or a jQuery selector which will identify the node(s).
	 * @param {integer} column the column that a click on this node will sort on
	 * @param {function} [callback] callback function when sort is run
	 * @returns {DataTables.Api} this
	 */
	_api_register( 'order.cn.itcast.mq.listener()', function ( node, column, callback ) {
		return this.iterator( 'table', function ( settings ) {
	...
	DataTable.models.oColumn = {
		 ...
		 * cn.itcast.mq.listener is attached to (if sorting is enabled.)
		 *  @type node
		 *  @default null
		 */
		"nTh": null,
	...
	$.extend( true, DataTable.ext.renderer, {
		header: {
			_: function ( settings, cell, column, idx, classes ) {
				...
				// Attach a sort cn.itcast.mq.listener to update on sort
