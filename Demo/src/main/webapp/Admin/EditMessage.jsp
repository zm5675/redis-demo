...
<body class="gray-bg">
    <div class="page-content-wrap">
        <form class="layui-form" action="${pageContext.request.contextPath}/UpdateMessageServlet" method="post">
            <div class="layui-tab" style="margin: 0;">
                <div class="layui-tab-content">
                    <div class="layui-tab-item">留言回复</div>
                    <input type="hidden" name="id" value="${message.id}">
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            <label class="layui-form-label">回复内容：</label>
                            <div class="layui-input-block">
                                <input type="text" name="Content1" value="${message.content1}" id="content1" placeholder="请输入回复内容" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                    </div>
                </div>
