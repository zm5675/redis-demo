...
<body class="gray-bg">
    <div class="page-content-wrap">
        <form class="layui-form" action="${pageContext.request.contextPath}/UpdateGoodTypeServlet" method="post">
            <div class="layui-tab" style="margin: 0;">
                <div class="layui-tab-content">
                    <div class="layui-tab-item">图书类型信息管理</div>
                    <input type="hidden" name="id" value="${goodType.id}">
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            <label class="layui-form-label">类型：</label>
                            <div class="layui-input-block">
                                <input type="text" name="goodTypeName" value="${goodType.goodTypeName}" id="goodTypeName" placeholder="请输入图书类型信息" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                    </div>
                </div>
