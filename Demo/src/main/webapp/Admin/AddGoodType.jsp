...
<body class="gray-bg">
    <div class="page-content-wrap">
        <form class="layui-form" action="${pageContext.request.contextPath}/AddGoodTypeServlet" method="post">
            <div class="layui-tab" style="margin: 0;">
                <div class="layui-tab-content">
                    <div class="layui-tab-item">图书类型</div>
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            <label class="layui-form-label">类型名称：</label>
                            <div class="layui-input-block">
                                <input type="text" name="GoodType"  id="GoodType" placeholder="请输入图书类型" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                    </div>
                </div>
