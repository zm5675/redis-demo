...
<body class="gray-bg">
    <div class="page-content-wrap">
        <form class="layui-form" action="${pageContext.request.contextPath}/UpdateUserServlet" method="post">
                    ...
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="userName" value="${user.userName}" id="userName" placeholder="请输入账号" autocomplete="off" class="layui-input"/>
                            </div>
                        </div>
                        <div class="layui-form-item">
