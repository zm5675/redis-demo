...
public class GoodListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Good> list = template.query(sb.toString(),new BeanPropertyRowMapper<Good>(Good.class),params.toArray());
        ...
        List<GoodType> list1 = template.query(sql,new BeanPropertyRowMapper<GoodType>(GoodType.class),params2.toArray());
