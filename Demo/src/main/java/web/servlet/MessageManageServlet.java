...
public class MessageManageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select a.*,b.UserName from Message a join User b on a.UserID=b.id  where 1 = 1";
        ...
        request.getRequestDispatcher("Admin/MessageManage.jsp").forward(request,response);
    }
