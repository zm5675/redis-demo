...
@WebServlet("/AdminInfoManageServlet")
public class AdminInfoManageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Admin> list = template.query(sql,new BeanPropertyRowMapper<Admin>(Admin.class),params.toArray());
        PageBean<Admin> pb = new PageBean<Admin>();
        pb.setCurrentPage(Integer.parseInt(currentPage));
        pb.setRows(Integer.parseInt(rows));
        String sql1 = "select count(*) from Admin where 1 = 1 ";
        ...
        request.getRequestDispatcher("Admin/AdminInfoManage.jsp").forward(request,response);
    }
