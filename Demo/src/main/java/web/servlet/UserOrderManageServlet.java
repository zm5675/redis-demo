...
@WebServlet("/UserOrderManageServlet")
public class UserOrderManageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select a.*,b.UserName from Orders a inner join USER b on a.UserID=b.id where 1 = 1 and a.UserID='"+userId+"'";
        ...
        String sql1 = "select count(*) from Orders where 1 = 1 and UserID='"+userId+"'";
