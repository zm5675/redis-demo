...
@WebServlet("/GoodTypeManageServlet")
public class GoodTypeManageServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String sql = "select * from GoodType  where 1 = 1";
        ...
        PageBean<GoodType> pb = new PageBean<GoodType>();
        pb.setCurrentPage(Integer.parseInt(currentPage));
        pb.setRows(Integer.parseInt(rows));
        String sql1 = "select count(*) from GoodType where 1 = 1 ";
        ...
        request.getRequestDispatcher("Admin/GoodTypeManage.jsp").forward(request,response);
    }
